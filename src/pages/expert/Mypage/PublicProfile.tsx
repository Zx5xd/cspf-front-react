        ...
        <Card>
            <Card.Header className={' position-relative'}>
                <div className="card-actions float-right">
                    <Dropdown className={'position-absolute top-0 end-0'}>
                        ...
                        <Dropdown.Menu>
                            <Dropdown.Item href="#" onClick={handleSetDetailProfile}>상세 프로필 작성</Dropdown.Item>
                        </Dropdown.Menu>
                    </Dropdown>
                </div>
            ...
            <Card.Body>
                <Form>
                    <Row>
                        <Col md={8} className={'mt-5'}>
                            ...
                            <Form.Group controlId="inputUsername" className={'mt-1'}>
                                <Row>
                                    <Col md={6}><Form.Label>성함</Form.Label></Col>
                                    <Col md={6}><Form.Label>회사명</Form.Label></Col>
                                </Row>
                            </Form.Group>

                            <Form.Group controlId="inputBio" className={'mt-4'}>
                                <Row>
                                    <Col md={6}><Form.Label>{profile && profile.name}</Form.Label></Col>
                                    <Col md={6}><Form.Label>{profile && profile.company}</Form.Label></Col>
                                </Row>
                            </Form.Group>
                        ...
                        <Col md={4}>
                            <div className="text-center">
                                <img
                                    ...
                                    src={ profile && (profile.image ? (profile.image) : `https://bootdey.com/img/Content/avatar/avatar1.png`)}
                    ...
                    <Row>
                        <Col md={12}>
                            <p className={'fs-5 pt-5 text-lg-start'}>상세 프로필(경력, 상품 등)</p>
                            <footer className="blockquote-footer ms-4 text-lg-start">정보는 오른쪽 상단 바를 통해 추가해주세요.</footer>
                        </Col>
                    </Row>
                    <Row>
                        <Col>
                            <Card className={'h-100'}>
                                <CardBody className={'text-start p-2'}>
                                    ...
                                    <Row>
                                        <Col md={5}>{publicProfile && publicProfile.workexperience}</Col>
                    ...
                    <Row>
                        <Col md={12}>
                            <p className={'fs-5 pt-5 text-lg-start'}>상세 프로필(회사 정보)</p>
                            <footer className="blockquote-footer ms-4 text-lg-start">정보는 오른쪽 상단 바를 통해 추가해주세요.</footer>
                        </Col>
                    </Row>
                    <Row>
                        <Col>
                            <Card className={'h-100'}>
                                <CardBody className={'text-start p-2'}>
                                    <Row className={'mb-2'}>
                                        <Col md={7}>{publicProfile && publicProfile.companyaddr}</Col>
