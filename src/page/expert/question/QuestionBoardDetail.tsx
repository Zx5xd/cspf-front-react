...
export const QuestionBoardDetail = () => {
    ...
    return (
        <div className="container mx-auto p-4 max-w-5xl">
            ...
            <article className="mb-8">
                ...
                <div className={"flex place-content-end mt-16 me-10"}>
                    <Dialog>
                        <DialogTrigger asChild>
                            <Button variant={'outline'} className={'me-5'}>수정</Button>
                        </DialogTrigger>
                        <DialogContent>
