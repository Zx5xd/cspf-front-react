...
// 타입 정의
type QuesWriteFormValues = z.infer<typeof quesWriteSchema>;

export const QuesWriteForm = () => {
    const {
        register,
        handleSubmit,
        formState: {errors},
    } = useForm<QuesWriteFormValues>({
        resolver: zodResolver(quesWriteSchema),
    });

    const onSubmit = (data: any) => {
        console.log(data)
        BoardWrite('questions', data).then((data)=>console.log(data))
    }
