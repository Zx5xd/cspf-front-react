...
import {BoardUpdate, BoardWrite} from "@/services/BoardManage.ts";
...
// 타입 정의
type AnnWriteFormValues = z.infer<typeof annWriteSchema>;

export const AnnWriteForm = () => {
    const {
        register,
        handleSubmit,
        formState: {errors},
    } = useForm<AnnWriteFormValues>({
        resolver: zodResolver(annWriteSchema),
    });

    const onSubmit = (data: any) => {
        console.log(data)
        BoardWrite('announcement', data).then((data)=>console.log(data))
    }
