...
export const announceManageColumns: ColumnDef<AnnounceEntity>[] = [
  {
    accessorKey: "id",
    header:  ({ column }) => {
      return (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return(
        <Button variant={"outline"} className={''} onClick={() => navigate('/admin/anDetail', {state: row.original})}>조회</Button>
          )
    },
  },
]
