...
export const quesManageColumns: ColumnDef<QuestionsEntity>[] = [
  {
    accessorKey: "id",
    header:  ({ column }) => {
      return (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return(    <Button variant={"outline"} className={''} onClick={()=> navigate('/admin/quesDetail', {state: row.original})}>조회</Button>)
},
  },
   // {
   //   id: "actions",
